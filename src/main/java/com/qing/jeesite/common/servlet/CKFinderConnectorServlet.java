 ...
 */
package com.qing.jeesite.common.servlet;
...
import com.qing.jeesite.common.utils.FileUtils;
...
@WebServlet(urlPatterns = "/static/ckfinder/core/connector/java/connector.java", initParams = {
        ...
        @WebInitParam(name = "configuration", value = "com.qing.jeesite.common.web.CKFinderConfig")
}, loadOnStartup = 1)
