...
import com.qing.jeesite.common.security.shiro.session.CacheSessionDAO;
import com.qing.jeesite.common.security.shiro.session.SessionManager;
import com.qing.jeesite.modules.sys.security.FormAuthenticationFilter;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(CacheSessionDAO dao) {
        ...
        sessionManager.setSessionIdCookie(new SimpleCookie("qing.jeesite.session.id"));
